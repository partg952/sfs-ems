...
import { Users01, UserCheck01, UserX01, ArrowRight } from '@untitledui/icons'
import { useAuth } from '../context/AuthContext'
import { getEmployees } from '../api/employees'
import StatCard from '../components/StatCard'
import PageHeader from '../components/PageHeader'
import { StatCardSkeletonRow, TableSkeleton } from '../components/Skeleton'
...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {loading ? (
        <>
          <div className="mb-8"><StatCardSkeletonRow count={4} /></div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <StatCard label="Total Employees" value={employees.length} icon={Users01} />
            <StatCard label="Active"          value={active}           icon={UserCheck01} tone="green" />
            <StatCard label="Left"            value={left}             icon={UserX01}     tone="red" />
            <StatCard label="Rejoined"        value={rejoined}         icon={UserCheck01} tone="blue" />
          </div>
